...
export default function Navbar() {
    ...
    return (
        ...
        <ul className="flex flex-col p-4 md:p-0 mt-4 rounded-lg bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
                <Link href="/" className={`block ${pathname === '/' ? '!text-[#E00729]' : ''} py-4 px-3 text-xs text-[#303030]  rounded md:bg-transparent md:p-0 md:dark:text-blue-500`}>HOME</Link>
            </li>
            <li className="group relative">
                <Link href="#" className={`block ${pathname === '/departments' ? '!text-[#E00729]' : ''} py-4 flex px-3 text-xs text-[#303030] hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#E00729] md:p-0 md:dark:hover:text-blue-500 dark:text-[#303030] dark:hover:bg-gray-700 dark:hover:text-[#303030] md:dark:hover:bg-transparent dark:border-gray-700`}>PRODUCTS
                ...
                <ul className="hidden group-hover:block absolute left-0 top-full w-56 bg-white text-xs text-gray-700 dark:text-gray-400 dark:bg-gray-800">
                    <li id="medical-li" className="relative">
                        ...
                        <ul id="medical-list" className="hidden  absolute left-full top-2 w-56 bg-white text-xs text-gray-700 dark:text-gray-400 dark:bg-gray-800">
                            <li>
                    ...
                    <li id="solutions-li">
                        ...
                        <ul id="solutions-list" className="hidden  absolute left-full top-11 w-56 bg-white text-xs text-gray-700 dark:text-gray-400 dark:bg-gray-800">
                            <li>
                    ...
                    <li id="patient-li">
                        ...
                        <ul id="patient-list" className="hidden  absolute left-full top-20 w-56 bg-white text-xs text-gray-700 dark:text-gray-400 dark:bg-gray-800">
                            <li>
            ...
            <li>
                <Link href="/about" className={`block ${pathname === '/about' ? '!text-[#E00729]' : ''} py-4 px-3 text-xs text-[#303030] hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#E00729] md:p-0 md:dark:hover:text-blue-500 dark:text-[#303030] dark:hover:bg-gray-700 dark:hover:text-[#303030] md:dark:hover:bg-transparent dark:border-gray-700`}>ABOUT US</Link>
            </li>
            <li>
                <Link href="/contact" className={`block ${pathname === '/articles' ? '!text-[#E00729]' : ''} py-4 px-3 text-xs text-[#303030] hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#E00729] md:p-0 md:dark:hover:text-blue-500 dark:text-[#303030] dark:hover:bg-gray-700 dark:hover:text-[#303030] md:dark:hover:bg-transparent dark:border-gray-700`}>CONTACT</Link>
            </li>
        </ul>
    </div>
    );
