...
<footer className="bg-[#bb1f22]  dark:bg-gray-900">
      ...
      <div className="grid grid-cols-1 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
             <div className="mb-6 md:mb-0">
                  <a href="/" className="flex items-center">
                      <img src="/mediinnov_logo_w.png" className="w-[150px] me-3" alt="MEDIINNOV  Logo" />
                  </a>
              </div>
        </div>
        <div>
        ...
        <div>
           <h2 className="mb-6 text-lg font-semibold text-white uppercase dark:text-white">Contact info</h2>
            <ul className="text-[#D2EDF6]dark:text-white font-medium">
                <li className="mb-4">
                  <p className="text-[#D2EDF6]">
                     131 BOULEVARD ANFA RESIDENCE AZUR BUREAU N 11 B, 20000 CASABLANCA
                  </p>
                </li>
                <li className="mb-4 text-[#D2EDF6]">
                    <a href="tel:+212673 142 929" className="hover:underline">(+212) 673 142 929</a>
                </li>
                <li className="mb-4 text-[#D2EDF6]">
                    <a href="mailto:contact@mediinnov.ma" className="hover:underline break-words ">contact@mediinnov.ma</a>
                </li>
              
            </ul>
        </div>
    </div>
    <div className="px-4 py-6 mt-11 md:flex md:items-center md:justify-between">
        <span className="text-sm text-[#D2EDF6] dark:text-gray-300 sm:text-center">© 2024 <a href="/">MEDI'INNOV™</a>. All Rights Reserved.
        </span>
