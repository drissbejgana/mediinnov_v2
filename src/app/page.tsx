  ...
  return (
   <div>
     ...
     <section className="max-w-screen-xl mx-auto">
        ...
        <p className="text-center text-md text-[#343131] font-semibold ">MEDIINOV est spécialisée dans la commercialisation des dispositifs médicaux et équipements, pour les secteurs public et privé. A la fois éditeur, distributeur et intégrateur, MEDIINNOV est le seul groupe au Maroc à proposer une solution globale totalement intégrée couvrant l’intégralité des besoins d'un centre ou service d’imagerie:</p>
        <Slider/>
